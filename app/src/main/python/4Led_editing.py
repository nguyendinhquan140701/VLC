...
def process_frame(frame, heigth, width, thresholdDefault, Npixel):
    try:
        ...
        byte_array1 = buffer.tobytes()
        return Data([],str(""),0.0,str(""),str(""), str(""))
...
def check_roi_tu_arr(str_x, Y, top, bot, Npixel):
    ...
    if abs(max2 - min2) >= 50*Npixel and gocLech <= 2  and str_[1] > 0 and str_outout2 != 0 :
        str_outout3[0] = (x_top2 + x_bot2)/2
        str_outout3[1] = min2
        str_outout3[2] = (x_top2 + x_bot2)/2
    ...
    elif abs(max2 - min2) >= 50*Npixel and gocLech > 2 and str_[1] > 0 and str_outout2 != 0:
    ...
    # elif abs(max2 - min2) <= 50*Npixel and str_[1] > 0:
    #     str_outout2[0] = (x_top2 + x_bot2)/2
    #     str_outout2[1] = min2 - 3*Npixel
    #     str_outout2[2] = (x_top2 + x_bot2)/2
    #     str_outout2[3] = max2 + 3*Npixel
    ...
    # if abs(max3 - min3) >= 50*Npixel and gocLech <= 2 and str_outout4 == 0:
    #     str_outout3[0] = (x_top3 + x_bot3)/2
    #     str_outout3[1] = min3 - 2*Npixel
    #     str_outout3[2] = (x_top3 + x_bot3)/2
    #     str_outout3[3] = min3 + 22*Npixel
    #
    #     str_outout4[0] = (x_top3 + x_bot3)/2
    #     str_outout4[1] = max3 - 22*Npixel
    #     str_outout4[2] = (x_top3 + x_bot3)/2
    #     str_outout4[3] = max3 + 2*Npixel
    #
